...
This project is indexed by GitNexus as **jam-p2p** (778 symbols, 1221 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
