...
This project is indexed by GitNexus as **jam-p2p** (780 symbols, 1223 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
