...
This project is indexed by GitNexus as **jam-p2p** (819 symbols, 1130 relationships, 13 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
