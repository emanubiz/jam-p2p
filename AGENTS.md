...
This project is indexed by GitNexus as **jam-p2p** (816 symbols, 1302 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
