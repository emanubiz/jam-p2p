...
This project is indexed by GitNexus as **jam-p2p** (831 symbols, 1326 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
